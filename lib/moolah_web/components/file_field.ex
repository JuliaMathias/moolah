defmodule MoolahWeb.Components.FileField do
  @moduledoc """
  The `MoolahWeb.Components.FileField` module provides a versatile and customizable component
  ...
  import MoolahWeb.Components.Progress, only: [progress: 1]
