defmodule MoolahWeb.Components.Clipboard do
  @moduledoc """
  The `MoolahWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
