defmodule MoolahWeb.Components.Spinner do
  @moduledoc """
  The `MoolahWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `MoolahWeb.Components.Spinner` module enables developers to provide
