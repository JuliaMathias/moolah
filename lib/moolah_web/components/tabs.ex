defmodule MoolahWeb.Components.Tabs do
  @moduledoc """
  `MoolahWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import MoolahWeb.Components.Badge, only: [badge: 1]
