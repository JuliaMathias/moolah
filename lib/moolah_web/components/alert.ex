defmodule MoolahWeb.Components.Alert do
  @moduledoc """
  MoolahWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
