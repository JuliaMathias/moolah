defmodule MoolahWeb.Components.PasswordField do
  @moduledoc """
  The `MoolahWeb.Components.PasswordField` module is a Phoenix component designed to render a customizable
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      ...
      Gettext.dgettext(MoolahWeb.Components.PasswordField.Gettext, "errors", msg, opts)
    end
  end
end
