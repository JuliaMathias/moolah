defmodule MoolahWeb.Components.NativeSelect do
  @moduledoc """
  The `MoolahWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `MoolahWeb.Components.NativeSelect`
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MoolahWeb.Gettext, "errors", msg, msg, count, opts)
    else
