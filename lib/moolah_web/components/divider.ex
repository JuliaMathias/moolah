defmodule MoolahWeb.Components.Divider do
  @moduledoc """
  The `MoolahWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `MoolahWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
