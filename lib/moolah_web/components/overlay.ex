defmodule MoolahWeb.Components.Overlay do
  @moduledoc """
  The `MoolahWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `MoolahWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
