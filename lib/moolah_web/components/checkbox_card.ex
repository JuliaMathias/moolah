defmodule MoolahWeb.Components.CheckboxCard do
  @moduledoc """
  The `MoolahWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
