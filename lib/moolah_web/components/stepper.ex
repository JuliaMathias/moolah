defmodule MoolahWeb.Components.Stepper do
  @moduledoc """
  The `MoolahWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `MoolahWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
