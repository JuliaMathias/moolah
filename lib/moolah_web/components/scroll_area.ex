defmodule MoolahWeb.Components.ScrollArea do
  @moduledoc """
  The `MoolahWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
