defmodule MoolahWeb.Components.Banner do
  @moduledoc """
  MoolahWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
