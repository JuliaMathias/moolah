defmodule MoolahWeb.Components.Menu do
  @moduledoc """
  The `MoolahWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `MoolahWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import MoolahWeb.Components.Accordion, only: [accordion: 1]
  import MoolahWeb.Components.Button, only: [button_link: 1]
