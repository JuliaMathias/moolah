defmodule MoolahWeb.Components.CheckboxField do
  @moduledoc """
  MoolahWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
