defmodule Moolah.Repo.Migrations.InitializeAndAddAuthenticationResourcesAndAddPasswordAuthenticationAndAddPasswordAuthAndAddMagicLinkAuthAndInstallAshMoneyAndAddLedgerExtensions1 do
  @moduledoc """
